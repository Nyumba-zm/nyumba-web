            ...
            {subscribed ? (
              ...
              <form onSubmit={handleSubscribe} className="flex gap-3 w-full lg:w-auto">
                <input
                  ...
                  className="flex-1 lg:w-64 px-4 py-3 rounded-lg bg-stone-800 border border-stone-700 text-white placeholder:text-stone-500 focus:outline-none focus:border-primary-500"
                  required
                />
                <button
                  type="submit"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-stone-400 text-sm mb-6 max-w-sm">
              Zambia&apos;s trusted real estate platform. Find verified properties,
              get AI-powered valuations, and connect with financing solutions.
            </p>
        ...
        <div className="border-t border-stone-800 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-stone-500">
              &copy; {new Date().getFullYear()} Nyumba. All rights reserved.
            </p>
            <div className="flex gap-6">
              <Link
                href="/terms"
                className="text-sm text-stone-500 hover:text-primary-400 transition-colors"
              >
                Terms
              </Link>
              <Link
